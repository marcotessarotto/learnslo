...
enota[1] = (
    ...
    ("srečati", "incontrare", WordType.VERB, WebLink("https://it.glosbe.com/sl/it/sre%C4%8Dati")),
    ("srečam", "io incontro"),
    # ("srečava", "noi due incontriamo"),
    ("srečamo", "noi incontriamo"),
    ("srečate", "voi incontrate"),
    ("srečajo", "loro incontrano"),
    ("sreča", "fortuna"),
    ...
    ("veste, tukaj je ob desetih zvečer mir", "sapete, qui alle dieci di sera c'è silenzio"),
    ("tukaj", "qui"),
    ...
    ("ob desetih zvečer", "alle dieci di sera"),
    ...
    ("zakaj mi to govoriš?", "perché mi dici questo?"),
    ...
    ("novega soseda povabi na pijačo", "invita il nuovo vicino a bere qualcosa"),
    ("povabi na pijačo", "lui invita a bere qualcosa"),
    ("povabiti", "invitare", WordType.VERB),
    ("ali", "o"),
    ...
    ("spregledali", "persi"),
    ("pijača", "bevanda", WebLink("https://it.glosbe.com/sl/it/pija%C4%8Da")),
    ("bomo dobili", ("avremo", "otterremo")),
    ("on začne", "lui inizia"),
